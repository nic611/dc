// https://github.com/thundernet8/React-Limited-Infinite-Scroll/blob/master/README-CN.md
...
export default class LimitedInfiniteScroll extends Component {
    static propTypes = {
        ...
        scrollerNode: PropTypes.string
    }

    static defaultProps = {
        scrollerNode: '.app-content',
        limit: 5,
        pageStart: 0,
        threshold: 200,
        hasMore: true,
    ...
    scrollHandler = () => {
        ...
        if (this.props.useWindow) {
          ...
          const scrollEl = document.querySelector(this.props.scrollerNode)
    ...
    render () {
        const {limit, pageStart, threshold, hasMore, autoLoad, useWindow, loadNext, spinLoader, mannualLoader, noMore, children, scrollerNode, ...props} = this.props
