...
export default class Dock extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.isVisible !== prevProps.isVisible) {
      // cc修改
      if (this.refs.view) {
        const view = ReactDom.findDOMNode(this.refs.view).querySelector('div')
        if (view) {
          this.setState({size: view.scrollHeight / this.state.fullHeight})
        }
      }
    ...
    return (
      <div style={Object.assign({}, styles.wrapper, { zIndex })}>
        ...
        <div style={dockStyles}>
          ...
          {/* cc修改 */}
          <div ref="view" style={styles.dockContent}>
