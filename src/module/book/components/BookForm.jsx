    ...
    return (
      <div className="f-14 book-return-item" >
        <div data-flex="box:last cross:center">
          <div>
            <div data-flex="cross:center" className="m-v-30" onClick={() => this.props.selectCity(this.props.depName, this.props.depCode, 0)}>
              <SVG svg={iconBookFlyFrom} className="icon-60" fill="#C93E3D" data-flex-box="0" />
              <div data-flex-box="0" className="f-16 m-h-30">出发城市</div>
              <div data-flex-box="2" className="f-20 a-r p-b-30 p-r-50 book-city f-dark">{this.props.depName}</div>
            </div>
            <div data-flex="cross:center" className="m-v-30" onClick={() => this.props.selectCity(this.props.arrName, this.props.arrCode, 1)}>
              <SVG svg={iconBookFlyTo} className="icon-60" fill="#C93E3D" data-flex-box="0" />
              <div data-flex-box="0" className="f-16 m-h-30">到达城市</div>
              <div data-flex-box="2" className="f-20 a-r p-b-30 p-r-50 book-city f-dark">{this.props.arrName}</div>
            </div>
          </div>
        ...
        <div data-flex="cross:center" onClick={() => viewUtils.dock(<BookPassenger />)}>
          ...
          <div data-flex-box="1" data-flex="main:center cross:center" className="book-date p-b-35 f-16" onClick={() => viewUtils.dock(<BookPassenger />)}>
